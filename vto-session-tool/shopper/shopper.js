...
export default async appContext => {
  console.log('VTO APP: HELLO FROM SHOPPER', appContext);
  ...
  const provider = await appContext.virtualTryOnApi.createProvider({
    vendorId: import.meta.env.VITE_VTO_VENDOR_ID,
    name: 'Snowy VTO',
  });
    ...
    if (product.sku === '48') {
      return {
        ...
        patterns: [{
          id: 'pattern-1',
          label: 'Circular',
          imageURL: 'https://labs.bambuser.com/jesper/platform/apps/vto-snowflakes/dashed-circle.png',
        }, {
          id: 'pattern-2',
          label: 'Rectangular',
          imageURL: 'https://labs.bambuser.com/jesper/platform/apps/vto-snowflakes/dashed-rect.png',
        }],
        variants: [{
          sku: '49',
          color: {
